...
- [Java лямбда-выражения и функциональные интерфейсы](#java-лямбда-выражения-и-функциональные-интерфейсы)
  - [Введение в лямбда-выражения](#введение-в-лямбда-выражения)
  - [Лямбды как параметры и результаты методов](#лямбды-как-параметры-и-результаты-методов)
...
- [БД](#бд)
  ...
  - [Кластерные и некластерные индексы](#кластерные-и-некластерные-индексы)
  - [Индексация данных с небольшим количеством возможных значений](#индексация-данных-с-небольшим-количеством-возможных-значений)
  - [Полное сканирование набора данных или индексирование](#полное-сканирование-набора-данных-или-индексирование)
  - [Транзакция](#транзакция)
  - [Требования к транзакциям](#требования-к-транзакциям)
  - [Уровни изолированности транзакций](#уровни-изолированности-транзакций)
  - [Проблемы при параллельном доступе с использованием транзакций](#проблемы-при-параллельном-доступе-с-использованием-транзакций)
  - [Cup теорема](#cup-теорема)
- [SQL](#sql)
  - [Что такое SQL](#что-такое-sql)
  - [Операторы SQL](#операторы-sql)
  - [NULL в SQL](#null-в-sql)
  ...
  - [Типы JOIN](#типы-join)
  - [JOIN или подзапросы](#join-или-подзапросы)
  - [Оператор HAVING](#оператор-having)
  - [Различие между HAVING и WHERE](#различие-между-having-и-where)
  ...
  - [Разница между GROUP BY и DISTINCT](#разница-между-group-by-и-distinct)
  - [Основные агрегатные функции](#основные-агрегатные-функции)
  - [Оператор EXISTS](#оператор-exists)
  - [Операторы IN, BETWEEN, LIKE](#операторы-in-between-like)
  - [Ключевое слово UNION](#ключевое-слово-union)
  - [Ограничения на целостность данных](#ограничения-на-целостность-данных)
  - [Отличия PRIMARY и UNIQUE](#отличия-primary-и-unique)
  - [Как создать индекс](#как-создать-индекс)
  - [Оператор MERGE](#оператор-merge)
  - [Отличие DELETE и TRUNCATE](#отличие-delete-и-truncate)
  - [Оператор EXPLAIN](#оператор-explain)
  - [Что такое RETURNING](#что-такое-returning)
  ...
  - [Разница типов данных DATETIME и TIMESTAMP](#разница-типов-данных-datetime-и-timestamp)
